 ...
 * Subpalettes
 */
$GLOBALS['TL_DCA']['tl_article']['subpalettes']['addImage'] =
    'singleSRC,alt,size,imagemargin,imageUrl,fullsize,caption,floating,linkedimage';
 ...
 */
array_insert(
    $GLOBALS['TL_DCA']['tl_article']['fields'], 1, array
(
    'addImage'    => array
    (
    ...
    public function pagePicker(DataContainer $dc)
    {
        return ' <a href="contao/page.php?do=' . \Input::get(
            ...
            str_replace("'", "\\'", $GLOBALS['TL_LANG']['MOD']['page'][0])
                ...
                'act'
            ) == 'editAll') ? '_' . $dc->id : '') . '\',\'self\':this});return false">' . $this->generateImage(
            'pickpage.gif', $GLOBALS['TL_LANG']['MSC']['pagepicker'], 'style="vertical-align:top;cursor:pointer"'
        ) . '</a>';
    }
}
