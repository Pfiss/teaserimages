 ...
 * Subpalettes
 */
$GLOBALS['TL_DCA']['tl_calendar_events']['subpalettes']['teaser_addImage'] =
    'teaser_singleSRC,teaser_alt,teaser_size,teaser_imagemargin,teaser_imageUrl,teaser_fullsize,teaser_caption,teaser_floating,teaser_linkedimage';
 ...
 */
array_insert(
    $GLOBALS['TL_DCA']['tl_calendar_events']['fields'], 1, array
(
